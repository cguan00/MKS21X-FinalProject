...
public class GameDemo {
  ...
  public GameDemo() {
    ...
    board.setSquares(blackP, whiteP); //sets up square\s[][] in Board
  }
	...
	public static void main(String[] args) {
		...
		while(running){
			...
			if (pressed == 1) { //if enter is pressed once, the user is choosing the piece to move
				...
				putString(20,22,terminal,"current square" + row + ", " + col);
			...
			if (key != null)
			{
				...
				if (key.getKind() == Key.Kind.valueOf("A")) {
					terminal.moveCursor(x,y);
					//terminal.putCharacter(' ');
					y++;
				}
				...
				putString(10,10,terminal,"xcor" + x);
				putString(10,15,terminal,"ycor" + y);//to clear leftover letters pad withspaces
